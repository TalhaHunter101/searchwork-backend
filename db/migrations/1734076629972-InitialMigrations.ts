...
export class InitialMigrations1734076629972 implements MigrationInterface {
  name = 'InitialMigrations1734076629972';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_job" ADD CONSTRAINT "FK_ccd8db87f300e682d477c9f5a20" FOREIGN KEY ("job_seeker_id") REFERENCES "job_seeker"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_job" DROP CONSTRAINT "FK_ccd8db87f300e682d477c9f5a20"`,
    );
    await queryRunner.query(
