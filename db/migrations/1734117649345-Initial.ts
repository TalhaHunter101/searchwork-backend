...
export class Initial1734117649345 implements MigrationInterface {
  name = 'Initial1734117649345';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."job_post_experience_level_enum" AS ENUM('entry', 'intermediate', 'senior', 'expert')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_05df4ce544b6615f9d121eb9344" FOREIGN KEY ("job_seeker_profile_id") REFERENCES "job_seeker"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_37bfb01591406f0fefaed6799a0" FOREIGN KEY ("location_id") REFERENCES "location"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "FK_05df4ce544b6615f9d121eb9344"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."job_post_experience_level_enum"`,
    );
